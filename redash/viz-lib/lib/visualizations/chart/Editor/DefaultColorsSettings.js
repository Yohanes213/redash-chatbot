...
function DefaultColorsSettings(_ref) {
  ...
  var series = (0, _react.useMemo)(() => (0, _lodash.map)((0, _getChartData.default)(data.rows, options), _ref2 => {
    var name = _ref2.name;
    return {
      key: name,
...
DefaultColorsSettings.propTypes = _propTypes.EditorPropTypes;
//# sourceMappingURL=DefaultColorsSettings.js.map