...
class ChatResource(BaseResource):
    def post(self):
        try:
            ...
            messages = [
                    SystemMessage(content= f'You are a helpful assistant.You will return a sql return a sql query to find the question. The database has the following schemas: {all_csv_info}'),
